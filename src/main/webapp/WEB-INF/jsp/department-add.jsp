...
<body>
<form id="from" action="/eastCMS/department/save" method="post" target="hidden_frame">
    <div class="ftitle">部门信息</div>
    <input id="id" type="text" style="display: none;"/>
    <div class="fitem">
            <span class="item-one">
                <label>部门名称:</label>
                <input name="dname" class="easyui-validatebox textbox" missingMessage="不能为空" validType="CHS" required="true" size="20" style="height: 25px;">
            </span>
